...
local config = {
  ...
  plugins = {
          ...
          require('neorg').setup {
            load = {
              ...
              ["core.keybinds"] = {
                config = {
                  ...
                  hook = function(keybinds)
                    keybinds.remap_event("norg", "n", "gtn", "core.norg.dirman.new.note")
                  end
                },
              },
              ["core.norg.dirman"] = {
              ...
              ["core.norg.completion"] = {
                config = {
                  engine = "nvim-cmp",
                  -- astronvim.add_cmp_source "neorg"
                }
              },
            }
          }
    ...
    heirline = function(config)
      -- Add breadcrumbs to statusline.
      -- table.insert(config[1], 6, astronvim.status.component.breadcrumbs())
      -- Disable the winbar.
      config[2] = nil
      return config
    end,
